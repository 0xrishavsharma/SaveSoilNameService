...
const App = () => {
	...
	const mintDomain = async () => {
		...
		const price = domain.length === 3 ? '0.0004' : (3 > domain.length && domain.length >= 10) ? '0.0003' : '0.0002';
	...
	const inputForm = () => {
		...
		return (
			<div className="form-container">
				...
				<input type="text" value={record} placeholder='Any comments?' onChange={e => setRecord(e.target.value)} />
